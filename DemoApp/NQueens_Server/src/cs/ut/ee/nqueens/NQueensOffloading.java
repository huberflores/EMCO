...
MessageReceiver receiver;
    ...
    private void changelabelcloud(String Huffmanintent){
     TextView tv1 = (TextView)this.findViewById(R.id.label);
     tv1.setText(Huffmanintent);
    }
    ...
    private void changelabellocal(String Huffmanintent){
    ...
    public class MessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
         ...
         if(iscloud){
         String Huffmanintent = intent.getStringExtra("Huffmanintent");
                
                changelabelcloud(Huffmanintent);
         }else{
         String HuffmanLocalintent = intent.getStringExtra("Huffmanintent");
